...
- **Fase 2 — Mutações**: `add_module` e `remove_module` implementados de ponta a ponta (com detecção de módulos dependentes); `update_dependency`/`update_metadata` ainda são stubs.
